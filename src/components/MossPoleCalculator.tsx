...
const MossPoleCalculator: React.FC = () => {
  ...
  // Price source management functions
  ...
  // Price Source Tracking Component
  const PriceSourceSection: React.FC<{ section: string; title: string }> = ({
    section,
  }) => {
    ...
    const handleSubmit = () => {
      ...
      addPriceSource(section, newSource);
      setFormData({ item: '', source: '', url: '', price: '', notes: '' });
      setNewSourceForms(prev => ({ ...prev, [section]: false }));
    };

    const sources = priceSources[section] || [];
    ...
    return (
      <Box sx={{ mt: 2 }}>
        <Button
          ...
          endIcon={expandedSections[section] ? <ExpandLess /> : <ExpandMore />}
          sx={{ mb: 1 }}
        >
          Price Sources{' '}
          {sources.length > 0 && (
                ...
                {sources.map(source => (
                  <ListItem key={source.id} sx={{ py: 0.5 }}>
                    ...
                    <ListItemSecondaryAction>
                      <IconButton
                        size="small"
                        onClick={() => removePriceSource(section, source.id)}
                        color="error"
                      >
                ...
                <Grid container spacing={1}>
                  <Grid item xs={12} sm={6}>
                    <TextField
                      ...
                      placeholder="e.g., PLA Filament, PET Sheet"
                    />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField
                  ...
                  <Grid item xs={12}>
                    <Box sx={{ display: 'flex', gap: 1 }}>
                      ...
                      <Button
                        size="small"
                        variant="outlined"
                        onClick={() => toggleNewSourceForm(section)}
                      >
                        Cancel
                      </Button>
                    </Box>
    ...
    <Box maxWidth="lg" sx={{ mx: 'auto', p: 3 }}>
      <Paper sx={{ p: 4 }}>
        ...
        >
          ...
          <PriceSourceSection section="filament" title="3D Printing" />
        </Paper>
        ...
        >
          ...
          <PriceSourceSection section="petSheet" title="PET Sheet" />
        </Paper>
        ...
        >
          ...
          <PriceSourceSection section="chickenWire" title="Chicken Wire" />
        </Paper>
        ...
        >
          ...
          <PriceSourceSection section="cableTies" title="Cable Ties" />
        </Paper>
        ...
        >
          ...
          <PriceSourceSection section="moss" title="Sphagnum Moss" />
        </Paper>
